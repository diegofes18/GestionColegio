 ...
 * @author marcc
 */
public class Asignatura_Estudiant implements Interficie_lista{
    
    private Nodo primer;
    private Nodo buid;
    
    public  Asignatura_Estudiant() {
        primer =  null;
    }
    ...
    public void addObject(Object a) {
        Nodo b =  new Nodo ((Estudiant)a, null );
    ...
    public  Estudiant  getInfo ( int  i ) {
        Nodo aux = primer;
        int j = 0 ;
        if (aux != null) {
        ...
        return (Estudiant)aux.Get_Object();
          }
        else {
            return  null ;
        }
...
public  Estudiant  getEstudiant ( String d ) {
        Nodo aux = primer;
        
        if (aux != null) {

        while ( ! aux.isEmpty () ) {
            if(((Estudiant)aux.Get_Object()).getDNI().equals(d)){
                return (Estudiant) aux.Get_Object();
            }
            if (aux.Get_Nodo() != null ){
                aux = aux.Get_Nodo ();
