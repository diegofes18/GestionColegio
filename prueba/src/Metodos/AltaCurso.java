...
public class AltaCurso extends JDialog implements ActionListener{
    ...
    private void initcomponents(){
        ...
        combo.addItem("Seleccioni Modalitat");
	combo.addItem("Batxiller");
	combo.addItem("FP");
        l1.setText("Seleccioni Modalitat");
        l2.setText("Nombre d'asignatures");
        l3.setText("Introdueix nom del curs");
        l4.setText("Introdueix el codi del curs");
        introasig.setText("Introduir Asignatures");
        ...
        combo.addActionListener(new ActionListener() {//add actionlistner to listen for change
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch (s) {//check for a match
                    case "Seleccioni Modalitat":
                        break;
                    case "Batxiller":
                        combo2.removeAllItems();
                        combo2.addItem("Primer");
                        combo2.addItem("Segon");
                        System.out.print("Batxiller");
                        break;
