    ...
    private void initcomponents(){
        ...
        aceptar.addActionListener(new ActionListener() {//add actionlistner to listen for change
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for(int i=0;i<todelete.getAsignatura_Estudiant().getlength();i++){
                    if((todelete.geteestu(i).getEstudiant_Asignatura().getlength()-1)==0)
                    le.deleteObject(todelete.geteestu(i));
                    todelete.geteestu(i).getEstudiant_Asignatura().deleteObject(todelete);
                }
...
//                    le.deleteObject(todelete.geteestu(i));
//                }
                System.out.println("ASIGNATURA DONADA DE BAIXA: "+deleted);
                cerrarVentana();
    ...
    public void MostrarMensaje(){
        JOptionPane.showMessageDialog(this, "No hi ha asignatures donades d'alta");
    }
